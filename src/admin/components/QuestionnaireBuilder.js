    ...
    return (
        <div className="builder">
            ...
            <div className="controls">
                <button onClick={() => addQ('text')}>+ Text</button>
                <button onClick={() => addQ('textarea')}>+ Long Text</button>
                <button onClick={() => addQ('date')}>+ Date</button>
                <button className="save" onClick={save}>Save Form</button>
            </div>
        </div>
    );
};
