...
class Portal_Shortcode {
    ...
    private static function enqueue_scripts() {
        // Path to the asset file generated by build
        ...
        // SAFETY CHECK: If build hasn't run yet, do NOT attempt to require the file.
        // This prevents the "Fatal error: require(): Failed opening required" crash.
